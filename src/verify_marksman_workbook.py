...
from build_marksman_workbook import ROW, IN, UNLOCK_LEVEL, MAPLE_HERO_RATIOS, R_TOTAL, CONTENT_TYPES  # noqa: E402
...
def hit_rate_per_sec(s, eff_cd):
    ...
    if fixed_duration_active:
        rate = non_buff_total_hits(eff_cd, hits_per_cast, icd, window) / fight_duration / effective_hits if effective_hits else 0
    else:
        rate = 1 / eff_cd
